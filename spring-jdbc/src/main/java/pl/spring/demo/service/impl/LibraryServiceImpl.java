...
public class LibraryServiceImpl implements LibraryService {
    ...
    private static final String FIND_ALL_LIBRARIES_SQL =
            "select id, name, address_id, type from Library";
    private static final String FIND_ALL_LIBRARIES_BY_NAME_SQL =
            "select id, name, address_id, type from Library where name = :name";
    private static final String FIND_ALL_LIBRARIES_IN_CITY_SQL =
            "select l.id, l.name, l.address_id, l.type from Library l, Address a where l.address_id = a.id and a.city = :city";
    private static final String FIND_ALL_LIBRARIES_BY_TYPE_SQL =
            "select id, name, address_id, type from Library where type = :type";
    private static final String FIND_ALL_LIBRARIES_HAVING_BOOK_SQL =
            "select l.id, l.name, l.address_id, l.type from Library l where exists (Select 1 from Book b where b.library_id = l.id and b.title like :title)";
    ...
    @Override
    public List<LibraryTo> findAllLibrariesByType(String type) {
